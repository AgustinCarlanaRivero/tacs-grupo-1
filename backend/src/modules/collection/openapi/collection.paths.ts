...
registry.registerPath({
    method: "post",
    path: "/users/{userId}/collection/items",
    tags: ["Collection"],
...
registry.registerPath({
    method: "patch",
    path: "/users/{userId}/collection/items/{stickerId}",
    tags: ["Collection"],
...
registry.registerPath({
    method: "post",
    path: "/users/{userId}/collection/missing",
    tags: ["Collection"],
...
registry.registerPath({
    method: "delete",
    path: "/users/{userId}/collection/missing/{stickerId}",
    tags: ["Collection"],
